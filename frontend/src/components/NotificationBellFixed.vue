<template>
  <div class="relative" ref="dropdownRef">
    ...
    <!-- Debug indicator -->
    <div v-if="isOpen" class="absolute top-0 left-0 w-2 h-2 bg-green-500 rounded-full"></div>
    
    <!-- Notification Dropdown -->
    <div 
      v-show="isOpen"
      class="absolute right-0 top-full mt-2 bg-white border-2 border-red-500 rounded-lg shadow-xl w-80 z-[9999]"
