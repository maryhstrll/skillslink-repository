  ...
  <Layout @logout="handleLogout">
    <div class="space-y-6">
      ...
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 class="text-3xl font-bold text-base-content">Academic Excellence Dashboard</h1>
          ...
          <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
              ...
              <div class="mt-4 text-center">
                <div class="stat-value text-info">{{ academicData?.job_alignment_rate?.overall_rate || 0 }}%</div>
                <div class="stat-desc">
                  {{ academicData?.job_alignment_rate?.aligned_jobs || 0 }} of {{ academicData?.job_alignment_rate?.total_employed || 0 }} 
                  employed alumni in aligned positions
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="overflow-x-auto">
                <table class="table table-zebra w-full">
                  ...
                  <tbody>
                    <tr v-for="(program, index) in academicData?.employment_by_program?.programs" :key="index">
                      ...
                      <td>
                        <span class="badge" :class="getBadgeClass(academicData.employment_by_program.employment_rates[index])">
            ...
            <div class="card-body">
              ...
              <div class="overflow-x-auto">
                <table class="table table-zebra w-full">
                  ...
                  <tbody>
                    <tr v-for="(program, index) in academicData?.job_alignment_rate?.by_program" :key="index">
                      <td class="font-medium">{{ program.program_name }}</td>
                      <td>{{ program.aligned_jobs }}</td>
                      <td>{{ program.total_employed }}</td>
                      <td>
                        <span class="badge" :class="getBadgeClass(program.alignment_rate)">
