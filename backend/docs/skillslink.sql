...
CREATE TABLE employment_records (
    ...
    employment_status ENUM('employed', 'unemployed', 'further_studies', 'not_looking') NOT NULL,
    company_name VARCHAR(100) NULL,
    occupation VARCHAR(100) NULL,
    job_description TEXT NULL,
    salary_range ENUM('Below 10,000','10,000 to 20,000','20,000 to 30,000','30,000 to 40,000','40,000 to 50,000','50,000 to 60,000','Above 60,000') NULL,
    work_classification ENUM('Wage and Salary Workers','Self-employed without any paid employee','Employer in Own Family-Operated Farm or Business','Work Without Pay in Own-Family-Operated Farm or Business') NULL,
    company_size ENUM('startup', 'small', 'medium', 'large', 'government') NULL,
    industry VARCHAR(100) NULL,
    work_location VARCHAR(100) NULL,
    is_local ENUM('yes','no') DEFAULT 'no',
    is_abroad ENUM('yes','no') DEFAULT 'no',
    nature_of_employment ENUM('Permanent','Casual','Contractual','Seasonal or Short Term') NULL,
